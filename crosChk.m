function points = crosChk(line, circle)
...
%   2017-01-04 changed the NaN output to 0 Lines 80,81 by Ahmed Abdelmohssen
%   changed the function name to "crosChk" by Ahmed Abdelmohssen
